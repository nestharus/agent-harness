...
## Source Artifact
- Converged Phase 2 r4 WU: `product-strategy/ai-roadmap-phase-2.md:2058`.
...
- Block canonical span/turn reference validation on WU-0C-N2 TranscriptTurn and source-offset DTO fixtures.
- Do not accept provider-native JSONL bodies, mutable transcript handles, file descriptors, SQLite handles, or adapter parser objects as DTO input.
...
- Same-wave peers from the r4 topological map: WU-2-01, WU-2-02, WU-2-03, WU-2-04, WU-2-05, WU-2-06, WU-2-13, WU-2-20, WU-2-21, WU-2-28, WU-2-29, WU-2-33.
