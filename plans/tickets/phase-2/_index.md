...
Source: `product-strategy/ai-roadmap-phase-2.md` from Phase 2 r4.

This directory supersedes the prior `tickets-phase-2-r3/plans/tickets/phase-2/` ticket directory. Phase 2 r4 is an audit-driven minor edit-pass from `proposal.md` Round 5, `engineering-roadmap.md` Round 4, and Phase 0C r4 `SessionOverrideContract` WU-0C-N1..WU-0C-N5. It preserves the 50-WU count and the 11-wave Parallelization Map while narrowing WU-2-22/23/24/26/43/45/46/47 around AgentRunnerClient and SessionOverrideContract boundaries.
...
- WU-2-43, WU-2-45, WU-2-46, and WU-2-47 carry the targeted WU-0C-N1..WU-0C-N5 SessionOverrideContract dependencies from the r4 cascade.
- WU-2-46 and WU-2-47 must use WU-0C-N1 write methods and WU-0C-N5 receipts/refusals for session-visible output; direct provider JSONL mutation stays forbidden.
