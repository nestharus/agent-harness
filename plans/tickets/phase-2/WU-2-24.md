...
## Source Artifact
- Converged Phase 2 r4 WU: `product-strategy/ai-roadmap-phase-2.md:1126`.
...
- Block on WU-0C-18 AgentRunnerClient invocation/resume evidence before implementing provider-specific substrate-gap/tool-surface mapping.
- Do not fall back to direct `opencode` command execution, provider/account selection, session-row mapping, or session-id capture if AgentRunnerClient support is incomplete.
...
- Same-wave peers from the r4 topological map: WU-2-08, WU-2-14, WU-2-22, WU-2-23, WU-2-27, WU-2-30, WU-2-39.
